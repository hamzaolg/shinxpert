...
if not st.session_state.started:
    ...
    st.markdown("Your smart shin guard performance dashboard.")
...
search_input = st.text_input("Enter player number to search", "")
player = players_data[0]  # valeur par défaut
...
st.markdown(f"### Player number {player['number']}")

# Carte stats
html = f"""
<div style='padding: 20px; border-radius: 20px; background-color: #f0f0f0; text-align: center;'>
    <p>🕒 <b>{player['time']}</b> Time played</p>
    <p>➕ <b>{player['injury']}</b> Injury</p>
    <p>⚡ <b>{player['speed']}</b> High Speed</p>
    <p>💙 <b>{player['heart']}</b> Heart rate</p>
</div>
"""
